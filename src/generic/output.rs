...
impl Output {
	...
	/// Requests the Launchpad Mini to send a so-called version inquiry. The version inquiry contains
	/// information about the current bootloader and firmware versions, as well as the size of the
	/// bootloader in KB.
	///
	/// In order to be able to receive the Launchpad Mini's response to this request,
	/// you must have a Launchpad Mini input object set up.
